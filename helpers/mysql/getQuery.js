...
exports.countires = function(){
  return "SELECT DISTINCT COUNTRY FROM sales"
}

exports.item_types = function(){
  return "SELECT DISTINCT ITEM_TYPE FROM sales"
}

exports.totals_by_country = function(country){
...
exports.totals_by_region = function(region){
...
exports.item_type_by_country  = function(country){
...
exports.item_type_by_region = function(region){
